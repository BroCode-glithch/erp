...
<div x-data="{ showModal: false, deleteUrl: '', loading: false }" class="px-4 py-6 sm:px-6 lg:px-8">
    ...
    <div class="overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div class="flex flex-col gap-4 p-4 border-b border-gray-200 dark:border-gray-700 md:flex-row md:items-center md:justify-between">
            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100">Permissions</h2>

            <div class="flex flex-col w-full gap-2 md:flex-row md:w-auto">
                <!-- Optional Search -->
                <input type="text" placeholder="Search permissions..." class="w-full px-3 py-2 text-sm text-gray-800 placeholder-gray-400 bg-white border border-gray-300 rounded-md md:w-64 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500" />
                ...
                <div class="flex flex-wrap gap-2">
                    ...
                    <a href="{{ route('admin.permissions.create') }}" class="px-4 py-2 text-sm text-white bg-blue-600 rounded-md hover:bg-blue-700">
                        + New Permission
                    </a>
                </div>
            </div>
