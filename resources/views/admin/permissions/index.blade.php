...
@section('title', 'Permissions | Admin | ' . setting('general.site_name'))
    ...
    <div x-data="{ showModal: false, deleteUrl: '', loading: false }" class="px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class="overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <div class="flex flex-col gap-4 p-4 border-b border-gray-200 dark:border-gray-700">
                ...
                <!-- Title -->
                <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Manage Permissions</h2>
                ...
                <div class="flex flex-col-reverse gap-4 md:flex-row md:items-center md:justify-between">
                    ...
                    <form action="{{ route('admin.permissions.index') }}" method="GET"
                        ...
                        <input type="text" name="search" value="#" placeholder="Search permissions..."
                    ...
                    <div class="flex flex-wrap items-center gap-2">
                        <a href="{{ route('admin.permissions.export.pdf') }}"
