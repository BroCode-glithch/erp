...
@section('title', 'Create Program | Admin | ' . setting('general.site_name'))
            ...
            <form action="{{ route('admin.programs.store') }}" method="POST" class="p-6">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}"
                        ...
                        class="mt-1 block w-full px-3 py-2 border dark:border-gray-600 rounded-md shadow-sm bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-100 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 @error('name') border-red-500 @enderror"
                        required>
