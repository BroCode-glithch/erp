...
<div x-data="{ showModal: false, deleteUrl: '', loading: false }" class="px-4 py-6 sm:px-6 lg:px-8">
    ...
    <div x-cloak x-show="showModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/50">
        <div @click.outside="showModal = false" class="w-full max-w-md p-6 bg-white rounded-lg shadow-lg dark:bg-gray-800">
            ...
            <p class="mt-2 text-sm text-gray-600 dark:text-gray-300">Are you sure you want to delete this program?</p>
        ...
        <div class="flex flex-col gap-4 p-4 border-b border-gray-200 dark:border-gray-700 md:flex-row md:items-center md:justify-between">
            ...
            <div class="flex flex-col w-full gap-2 md:flex-row md:w-auto">
                <!-- Optional Search -->
                <input type="text" placeholder="Search programs..." class="w-full px-3 py-2 text-sm text-gray-800 placeholder-gray-400 bg-white border border-gray-300 rounded-md md:w-64 dark:border-gray-600 dark:bg-gray-700 dark:text-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-500" />
