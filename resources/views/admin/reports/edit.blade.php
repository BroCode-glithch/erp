...
@section('title', 'Edit Reports | Admin | ' . setting('general.site_name'))
...
<div class="px-4 py-6 sm:px-6 lg:px-8">
    <div class="max-w-2xl mx-auto overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
        ...
        <div class="p-6 border-b border-gray-200 dark:border-gray-700">
            <h2 class="text-xl font-semibold text-gray-800 dark:text-gray-100">Edit Reports</h2>
        </div>

        <!-- Form -->
        <form action="{{ route('admin.reports.update', $report->id) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
