...
@section('title', 'Edit User(s) | Admin | ' . setting('general.site_name'))
...
@section('content')
    <div class="p-6">
        ...
        <form action="{{ route('admin.users.update', $user->id) }}" method="POST"
            ...
            <!-- Password -->
            <div class="mb-4">
                <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Password <span
