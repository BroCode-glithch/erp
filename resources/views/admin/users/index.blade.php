...
@section('title', 'Users | Admin | ' . setting('general.site_name'))
...
@section('content')
    <div class="px-4 py-6 sm:px-6 lg:px-8">
        <div class="overflow-hidden bg-white rounded-lg shadow-md dark:bg-gray-800">
            ...
            <!-- Header -->
            <div
                class="flex flex-col gap-4 p-4 border-b border-gray-200 dark:border-gray-700 md:flex-row md:items-center md:justify-between">
                ...
                <div class="flex flex-col w-full gap-2 md:flex-row md:w-auto">
                    ...
                    <div class="flex flex-wrap gap-2">
                        <a href="{{ route('admin.users.export.pdf') }}"
                            class="px-3 py-2 text-sm text-white bg-red-600 rounded-md hover:bg-red-700">Export PDF</a>
                        <a href="#"
                            class="px-3 py-2 text-sm text-white bg-green-600 rounded-md hover:bg-green-700">Export Excel</a>
                        <a href="#"
                            class="px-3 py-2 text-sm text-white bg-yellow-500 rounded-md hover:bg-yellow-600">Export XML</a>
                        <a href="{{ route('admin.users.create') }}"
                            class="px-4 py-2 text-sm text-white bg-blue-600 rounded-md hover:bg-blue-700">Add User</a>
                    </div>
                </div>
            </div>
            ...
            <div class="overflow-x-auto">
                ...
                <p class="px-4 py-2 text-sm text-center text-red-600 bg-red-50 dark:bg-gray-900 dark:text-red-400">
                    <strong>Note:</strong> This displays the users except for the currrent admin.
                </p>
                ...
                <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                    <thead class="bg-gray-50 dark:bg-gray-700">
                        <tr>
                            ...
                            <th class="px-6 py-3 text-xs font-medium text-left text-gray-500 uppercase dark:text-gray-300">
                                Roles</th>
                            <th class="px-6 py-3 text-xs font-medium text-right text-gray-500 uppercase dark:text-gray-300">
                                Actions</th>
                        </tr>
                    </thead>
