            ...
            <div class="p-6 space-y-6">
                ...
                <dl class="grid grid-cols-1 sm:grid-cols-2 gap-x-6 gap-y-4">
                    ...
                    <div>
                        ...
                        <dd>
                            @if($user->is_active)
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-green-100 text-green-800 dark:bg-green-700 dark:text-white">
                                    Active
                                </span>
                            @else
                                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium bg-red-100 text-red-800 dark:bg-red-700 dark:text-white">
                                    Inactive
                                </span>
                            @endif
                        </dd>
                    ...
                    <div class="sm:col-span-2">
                        ...
                        <dd class="mt-1 flex flex-wrap gap-2">
                            @forelse($user->roles as $role)
                                <span class="bg-blue-100 text-blue-800 dark:bg-blue-700 dark:text-white px-3 py-1 rounded-full text-sm font-medium">
                                    {{ $role->name }}
                                </span>
                            @empty
                ...
                <!-- Actions -->
                <div class="flex flex-wrap justify-between items-center pt-6 border-t border-gray-200 dark:border-gray-700 gap-2">
                    <!-- Edit -->
