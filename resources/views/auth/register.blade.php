<x-guest-layout>
    ...
    @section('title', 'Register | ' . setting('general.site_name'))
            ...
            <div class="relative z-20">
                ...
                <form method="POST" action="{{ route('register') }}" class="space-y-4">
                    ...
                    <div class="feature-card">
                        ...
                        <x-text-input id="name" placeholder="James Doe" class="block w-full mt-1" type="text"
                    ...
                    <div class="feature-card">
                        ...
                        <x-text-input id="email" placeholder="user@erp.com" class="block w-full mt-1" type="email"
                    ...
                    <div class="feature-card">
                        ...
                        <select id="role" name="role" required
                            class="block w-full mt-1 border-gray-300 rounded-lg shadow-sm focus:ring focus:ring-indigo-200 focus:ring-opacity-50">
                            <option value="">-- Choose a Role --</option>
                            <option value="admin" {{ old('role') == 'admin' ? 'selected' : '' }}>Admin</option>
                            <option value="program-manager" {{ old('role') == 'program-manager' ? 'selected' : '' }}>
                                Program Manager</option>
                            <option value="care-support" {{ old('role') == 'care-support' ? 'selected' : '' }}>Care
                                Support</option>
                        </select>
                    ...
                    <div class="feature-card">
                        ...
                        <x-text-input id="password_confirmation" placeholder="**********" class="block w-full mt-1"
                    ...
                    <div class="feature-card">
                        ...
                        <div x-data="{ enabled: false }" class="flex items-center mt-2 space-x-4">
                            <button type="button" @click="enabled = !enabled; $refs.input.value = enabled ? 1 : 0"
                                ...
                                <span :class="enabled ? 'translate-x-6' : 'translate-x-1'"
                                    class="inline-block w-4 h-4 transition-transform duration-300 transform bg-white rounded-full"></span>
                            </button>
